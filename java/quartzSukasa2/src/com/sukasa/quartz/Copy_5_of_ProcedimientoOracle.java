...
public class Copy_5_of_ProcedimientoOracle {
...
//			 "select * from maestro_tarjeton where MTMARCA=3586 and MTITEM=531";
			//String queryMaestroTarjeton ="select * from maestro_tarjeton where MTMARCA=3664 and MTITEM=8";
			...
			//String queryProgramasPortal = "SELECT CONCAT(CONCAT(IMARCA, '-'),ICOD) as SKU, DESCRIPCION FROM programa_portal WHERE IMARCA = 1729 AND ICOD IN (922,923,924,926,927,928)";
...
//			if(padre_id > 0){
//				System.out
//				.println("Se encontro un producto configurable en el producto: " + producto_id );
//			}
		} catch (SQLException e) {
			System.out.println("Error de MySQL: " + e.getMessage());
		} catch (Exception e) {
